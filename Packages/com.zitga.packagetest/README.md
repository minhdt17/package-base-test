...
<root>
  ...
  ├── Editor
  │   ├── Zitga.Packagetest.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Zitga.Packagetest.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Zitga.Packagetest.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Zitga.Packagetest.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Zitga.Packagetest`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package PackageTest Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Zitga.Packagetest.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Zitga.Packagetest.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Zitga.Packagetest.Editor.Tests.asmdef`

  `Tests/Runtime/Zitga.Packagetest.Tests.asmdef`
...
Use the `Documentations~/PackageTest.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
