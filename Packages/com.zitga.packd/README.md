...
<root>
  ...
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Zitga.Packd.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Zitga.Packd.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Zitga.Packd`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package PackD Manifest** page opens for editing.
...
Use the `Documentations~/PackD.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
